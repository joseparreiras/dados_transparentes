...
class BaixarObitosSpider(scrapy.Spider):
    name = 'baixar_obitos'
    allowed_domains = ['dadostransparentes.com.br']
    start_urls = ['http://www.dadostransparentes.com.br/graficos_regiao/obitos.php']

    def parse(self, response):
        uf_list = ['11','12','13','14','15','16','17','21','22','23','24','25','26','27','28','29',
        '31','32','33','35','41','42','43','50','51','52','53']
        for uf in uf_list:
            yield FormRequest('http://www.dadostransparentes.com.br/graficos_regiao/obitos.php',
